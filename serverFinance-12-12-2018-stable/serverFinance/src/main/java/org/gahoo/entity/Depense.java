...
@NamedQueries({
    ...
    @NamedQuery(name = "Depense.findByUuid", query = "SELECT d FROM Depense d WHERE d.uuid = :uuid"),
    @NamedQuery(name = "Depense.findByPosteUuid", query = "SELECT d FROM Depense d WHERE d.posteUuid = :posteUuid"),
    @NamedQuery(name = "Depense.findByUserUuid", query = "SELECT d FROM Depense d WHERE d.userUuid = :userUuid"),
    @NamedQuery(name = "Depense.findByCompteUuid", query = "SELECT d FROM Depense d WHERE d.compteUuid = :compteUuid"),
    ...
    @NamedQuery(name = "Depense.findByIsPlanified", query = "SELECT d FROM Depense d WHERE d.isPlanified = :isPlanified"),
    @NamedQuery(name = "Depense.findByIsPaid", query = "SELECT d FROM Depense d WHERE d.isPaid = :isPaid"),
    @NamedQuery(name = "Depense.findByFrequenceUuid", query = "SELECT d FROM Depense d WHERE d.frequenceUuid = :frequenceUuid"),
    @NamedQuery(name = "Depense.findByIsFacture", query = "SELECT d FROM Depense d WHERE d.isFacture = :isFacture"),
    @NamedQuery(name = "Depense.findByParentUuid", query = "SELECT d FROM Depense d WHERE d.parentUuid = :parentUuid"),
    @NamedQuery(name = "Depense.findByEtat", query = "SELECT d FROM Depense d WHERE d.etat = :etat"),
    @NamedQuery(name = "Depense.findByIsDeleted", query = "SELECT d FROM Depense d WHERE d.isDeleted = :isDeleted"),
    @NamedQuery(name = "Depense.findByCreatedAt", query = "SELECT d FROM Depense d WHERE d.createdAt = :createdAt"),
    @NamedQuery(name = "Depense.findByUpdatedAt", query = "SELECT d FROM Depense d WHERE d.updatedAt = :updatedAt")})
...
public class Depense implements Serializable {
    ...
    public void copy(Depense depense){
    	this.uuid=DataHelper.uuid();
    	this.setMontant(depense.getMontant());
    	this.setLibelle(depense.getLibelle());
    	this.setUserUuid(depense.getUserUuid());
    	this.setPosteUuid(depense.getPosteUuid());
    	this.setCompteUuid(depense.getCompteUuid());
    	this.setNombre(depense.getNombre());
    	
    }

    @Override
	public String toString() {
		return "Depense [id=" + uuid + ", posteUuid=" + posteUuid + ", userUuid=" + userUuid + ", compteUuid=" + compteUuid
